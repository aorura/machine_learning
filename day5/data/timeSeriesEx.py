...
longData = pd.Series(np.random.randn(1000),
...
ldFrame = pd.DataFrame(np.random.randn(100,3),
                       index=pd.date_range('1/1/2017', periods=100, freq='W-WED'),
...
print('\n', pd.date_range(start='4/1/2012', end='12/1/2012', freq='BM'))
print('\n', pd.date_range(start='5/2/2012 12:56:31', periods=5))
print('\n', pd.date_range(start='5/2/2012 12:56:31', periods=5, freq='4h'))
print('\n', pd.date_range(start='5/2/2012 12:56:31', periods=5, freq='1h30min'))
print('\n', pd.date_range(start='4/1/2012', end='12/1/2012', freq='WOM-2FRI'))
